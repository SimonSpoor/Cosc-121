...
//Animal should be abstract because we never directly call on it, but we do call on it's subclasses.
	private String name;
	...
	public int compareTo(Animal o) {
		return (int)(this.getEnergy() - o.getEnergy());
	}
	@Override
	...
	//Sound should be abstract, because there is no value attatched to it. This might cause issues further in development, so it's best to lock it away and be sure that no problems will arise
